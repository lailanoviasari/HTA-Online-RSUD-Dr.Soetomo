...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true"
    ...
    <script>
        const button = document.getElementById('btn_direkomendasikan');
        button.addEventListener('click', e => {
            e.preventDefault();
            Swal.fire({
                text: "Sukses direkomendasikan!",
                icon: "success",
    ...
    <script>
        const button_simpan = document.getElementById('btn_simpan');
        button_simpan.addEventListener('click', e => {
            e.preventDefault();
            Swal.fire({
