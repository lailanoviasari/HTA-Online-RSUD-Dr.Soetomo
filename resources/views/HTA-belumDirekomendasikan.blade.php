                ...
                <div class="card-footer">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <button type="button" id="btn_ditolak" class="btn btn-danger align-self-start me-2"
                                data-bs-toggle="modal" data-bs-target="#modal_ditolak">Ditolak</button>
                            <!--end::Button ditolak-->
                            <!--begin::Button kembali-->
                            <a href="/pengajuanVK" type="button" class="btn btn-secondary align-self-start me-2">Kembali</a>
                            <!--end::Button kembali-->
                        </div>
                    </div>
