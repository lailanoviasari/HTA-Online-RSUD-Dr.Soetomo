					...
					<div id="kt_app_content_container" class="app-container container-xxl">
						...
						<div class="card shadow-sm mb-5 mb-xl-10">
							...
							<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
								data-bs-target="#kt_pencarian" aria-expanded="true" aria-controls="kt_pencarian">
								<!--begin::Card title-->
								<div class="card-title m-0">
									<i class="bi bi-search fs-2 text-primary me-2"></i>
									<h3 class="fw-bold m-0 ">Pencarian</h3>
								</div>
								<!--end::Card title-->
							</div>
							<!--end::Card header-->
							...
							<!--begin::Content-->
							<div id="kt_pencarian_details" class="collapse show">
								<!--begin::Form-->
								<form id="kt_pencarian_form" class="form">
									...
									<div class="card-body border-top p-9">
										...
										<div class="row mb-5 ms-5 me-5">
											...
											<div class="col-xl-6">
												...
												<input class="form-control" placeholder="24/03/2023"
													id="kt_datepicker_1" />
											</div>
											<!--end::Tanggal-->
									...
									<div class="card-footer d-flex justify-content-first py-6 px-9">
										<button type="submit" class="btn btn-danger"
											id="kt_pencarian_submit">Cari</button>
									</div>
									<!--end::Actions-->
								</form>
								<!--end::Form-->
						...
						<!--begin::VITA RAHMADA-->
						<div class="card shadow-sm h-2000px" id="card_informasi">
							...
							<div class="card-body">
								...
								<div class="table-responsive text-center" type="button" data-bs-toggle="modal"
									...
									<table class="table table-striped gy-5 gx-5 table-hover"
										id="tabel_informasiPengajuan">
								...
								<div class="modal fade" tabindex="-1" id="modal_view_informasiPengajuan"
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="table-responsive text-center">
													<table class="table table-hover border gy-5 gs-5"
														id="tabel_informasiPengajuan">
														<thead class="border gy-5 gs-5">
															<tr
																class="fw-semibold fs-6 text-light bg-dark align-middle">
																<th class="min-w-50px">No. Pengajuan</th>
																<th class="min-w-200px">Jenis Pengajuan</th>
										...
										<div class="row">
											<div class="col">
												<div class="row">
													<div class="col"></div>
													<div class="col">
														<select class="form-select bg-light-primary"
