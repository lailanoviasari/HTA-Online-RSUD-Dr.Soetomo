...
@section('content-Ditolak')
    
				<!--begin::ditolak-->
				<div id="content4_ditolak" class="app-content flex-column-fluid">
					<div id="kt_app_content_container4" class="app-container container-xxl">
						...
						<div class="card shadow-sm h-2000px mb-10" id="card_belumDiverifikasi">
							...
							<div class="card-body">
								...
								<div class="row">
									<h1 class="text-dark fw-bold fs-4 mt-10">Dokumen Tingkat
										Keterbutuhan :
									</h1>
								</div>
								<div class="row mt-5">
								...
								<div class="row mt-2">
									<label class="fw-semibold col-lg-4">Apakah alat/teknologi kesehatan
										ini
										baru?</label>
								...
								<div class="row mt-2">
									...
									<div class="col-lg-8">Teknologi paling mutakhir yang wajib dimiliki
										oleh
										RS
								...
								<h1 class="text-dark fw-bold fs-4 my-5 mt-10">Dokumen Operasional dan
									Dokumen
									Aspek
									Sosio-Ekonomi </h1>
								...
								<div class="row">
									...
									<div class="col-8">
										...
										quasi
										possimus
										natus eveniet, repellendus eos adipisci tempora corporis
										voluptatibus
										commodi
										eius molestias! Amet enim ipsam minima recusandae omnis possimus
										maxime
										officia
										distinctio sit repellendus molestiae odio dolor aut cupiditate
										ratione
										laborum,
